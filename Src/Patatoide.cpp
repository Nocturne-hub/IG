...
void Patatoide::setAngleRotation(float angle) {
    angleRotation = angle;
}

void Patatoide::setAxeRotationX(float axe) {
    axeRotationX = axe;
}

void Patatoide::setAxeRotationY(float axe) {
    axeRotationY = axe;
}

void Patatoide::setAxeRotationZ(float axe) {
    axeRotationZ = axe;
}

void Patatoide::setDirection(int dir) {
    direction = dir;
}

void Patatoide::setSpeed(float s) {
    speed = s;
}
...
float Patatoide::getAngleRotation() {
    return angleRotation;
}

float Patatoide::getAxeRotationX() {
    return axeRotationX;
}

float Patatoide::getAxeRotationY() {
    return axeRotationY;
}

float Patatoide::getAxeRotationZ() {
    return axeRotationZ;
}

int Patatoide::getDirection() {
    return direction;
}
...
void Patatoide::myPatatoide(GLfloat c) {
    ...
    GLfloat face3[16][4] = {
      {p13[0], p13[1], p13[2], p13[3]},{p14[0], p14[1], p14[2], p14[3]},{p15[0], p15[1], p15[2], p15[3]},{p16[0], p16[1], p16[2], p16[3]},
      {p24[0], p24[1], p24[2], p24[3]},{-0.5F * c,-0.5F * c, -1.5F * c, 1.0F }, { 0.5F * c,-0.5F * c, -1.5F * c, 1.0F },{p17[0], p17[1], p17[2], p17[3]},
      {p23[0], p23[1], p23[2], p23[3]},{-0.5F * c, 0.5F * c, -1.4F * c, 1.0F }, { 0.5F * c, 0.5F * c, -1.4F * c, 1.0F },{p18[0], p18[1], p18[2], p18[3]},
      {p22[0], p22[1], p22[2], p22[3]},{p21[0], p21[1], p21[2], p21[3]},{p20[0], p20[1], p20[2], p20[3]},{p19[0], p19[1], p19[2], p19[3]} };
    GLfloat face4[16][4] = {
      {p1[0], p1[1], p1[2], p1[3]},{p2[0], p2[1], p2[2], p2[3]},{p3[0], p3[1], p3[2], p3[3]},{p4[0], p4[1], p4[2], p4[3]},
      {p25[0], p25[1], p25[2], p25[3]},{ 0.5F * c,-1.0F * c, 0.5F * c, 1.0F }, { 0.63F * c,-1.0F * c, 0.5F * c, 1.0F },{p26[0], p26[1], p26[2], p26[3]},
      {p29[0], p29[1], p29[2], p29[3]},{ 0.5F * c,-1.0F * c,-0.5F * c, 1.0F }, { 0.63F * c,-1.0F * c,-0.5F * c, 1.0F },{p30[0], p30[1], p30[2], p30[3]},
      {p13[0], p13[1], p13[2], p13[3]},{p14[0], p14[1], p14[2], p14[3]},{p15[0], p15[1], p15[2], p15[3]},{p16[0], p16[1], p16[2], p16[3]} };
    GLfloat face5[16][4] = {
